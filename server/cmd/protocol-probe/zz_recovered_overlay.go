...
func handleShopBuyCustom(link sceneMessageConnection, player *playerActor, world *sceneLifecycle, itemCatalog *itemCatalog, equipCatalog *equipCatalog, bagStore bagStoreIface, currencyStore currencyStoreIface, roleID role.RoleID, custom clientCustomMessage, remote string) (bool, error) {
